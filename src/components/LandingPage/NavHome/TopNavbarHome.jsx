        ...
        <NavInner className="container flexSpaceCenter">
          ...
          <UlWrapper className="flexNullCenter mt-3">
            <li className="semiBold font15 pointer">
              <a href='#panel' className="nav-link" style={{ padding: "10px 15px" }} spy={true} smooth={true} offset={-80}>
                Booking
              </a>
            </li>

            <li className="semiBold font15 pointer">
              <a href='#about' className="nav-link" style={{ padding: "10px 15px" }}  spy={true} smooth={true} offset={-80}>
                About Us
              </a>
            </li>

            <li className="semiBold font15 pointer">
              <a href='#destination' className="nav-link" style={{ padding: "10px 15px" }}  spy={true} smooth={true} offset={-80}>
                Destination
              </a>
            </li>

            <li className="semiBold font15 pointer">
              <a href='#testimonial' className="nav-link" style={{ padding: "10px 15px" }} spy={true} smooth={true} offset={-80}>
                Testimonial
              </a>
            </li>
          </UlWrapper>
