							...
							<form>
								<div className="form-group">
									<div className="form-checkbox">
										<label for="roundtrip">
											<input type="radio" id="roundtrip" name="flight-type" value="yes" onClick={handleShow}/>
											<span></span>Roundtrip
										</label>

										<label for="one-way">
											<input type="radio" id="one-way" name="flight-type" value="no" checked={showhide==='no'} onClick={handleShow}/>
											<span></span>One way
										</label>
									</div>
								</div>
